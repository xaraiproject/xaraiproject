...
**Real-progress-estimation** includes the full [control loop](https://en.wikipedia.org/wiki/Control_loop) of processes that seek to instantiate a goal’s *intended* change in the actual state of reality. This includes processes like estimation of progress, strategic decision-making, error-anticipation, error-correction, verification, etc. 

Maximizing real-progress-estimation is part of the structure of having a goal. It is not merely 'optimal' or 'morally good'—it follows from the internal logic of what a goal is.
To say, "I am committed to my goal but I am not going to prefer actions or processes that best advance that goal" is incoherent.
...
It is even fine to tactically exchange some process of real-progress-estimation for dispensable goods or later greater real-progress-estimation (eg. “I will cross the frozen river now without checking the thickness of the ice to save time”). However, this feature tends to make people mistakenly think that the capacity for real-progress-estimation *in its entirety* is a dispensable good.
...
This is not to say that dying cannot mean dying forever. It just means that agent cannot know for certain if their current belief is actually catastrophically wrong beforehand. Further real-progress-estimation can help discern if it is. 
...
Therefore, to avoid structural violation, coherent agents should prefer strategies that maximize their real-progress-estimation, which means not preferring strategies or actions that **prematurely** destroy the capacity for real-progress-estimation.

This is the Structural Imperative.

??? question "Clarifications and objections"
    **Q: What if my goal is 100% belief and I don't care about the state of reality?**

    A: Technically, your belief exists in reality. If your only goal is really to just believe something independently of reality outside of your belief, then the optimal move is just to try to mentally manipulate yourself (eg. [wireheading](https://en.wikipedia.org/wiki/Wirehead_(science_fiction))).
    ...
    **Q: Aren't you sliding between 'structural requirements' and merely optimal choices?**
    ...
    A: To clarify, selecting what you think is the best strategy among strategies in the process of maximizing real-progress-estimation can be called 'optimizing', but 'optimizing' is still below the structural requirement of maximizing real-progress-estimation.
...
This hedge is not concerned with belief; it is principally concerned with strategy. You can take strategic action even if you can’t necessarily muster genuine belief (eg. “I think the ice on the river is thick, but I will walk across it as if it is thin”).
...
This is essentially the Infinite Gods problem which many agnostics earnestly wrestle with. Many competing mutually exclusive claims make undecided neutrality seem safer.

However, within the context of the Structural Imperative and hedge for physical destruction, claims can be systematically evaluated by topple resistance.
...
The Pauline Asymmetry points to undisputed Pauline verses from 1 Corinthians and Galatians on [Papyrus 46](https://en.wikipedia.org/wiki/Papyrus_46) (P46). The three points it reveals are as follows:
...
In his book, *The New Testament: A Historical Introduction to the Early Christian Writings*, popular New Testament scholar and agnostic skeptic [Bart Ehrman](https://en.wikipedia.org/wiki/Bart_D._Ehrman) identifies the prevailing scholarly consensus on the authorship and dating of Pauline epistles:
...
The splitting of the moon in Qur’an 54:1 is also sometimes cited as a literal validating miracle of Muhammad’s prophethood. Yet, there is no independent contemporary astronomical record confirming it. A photograph of the [Rima Ariadaeus](https://en.wikipedia.org/wiki/Rima_Ariadaeus) is sometimes circulated as modern evidence for a past split and rejoining, but NASA has clarified that this rille is similar to Earth's geological faults and only spans approximately 300 km of the moon's 10,917 km circumfrence (less than 3%). Some scholars like Aziz al-Azmeh entertain the possibility that the 'splitting' was a lunar eclipse. [8]
...
??? info "Footnotes"
    ...
    (Epistle to the Galatians, Authorship section, Wikipedia, [https://en.wikipedia.org/wiki/Epistle_to_the_Galatians](https://en.wikipedia.org/wiki/Epistle_to_the_Galatians))
    ...
    (Epistle to the Galatians, Date section, Wikipedia, [https://en.wikipedia.org/wiki/Epistle_to_the_Galatians](https://en.wikipedia.org/wiki/Epistle_to_the_Galatians))
    ...
    [5]: Bart Ehrman, [https://ehrmanblog.org/were-the-disciples-martyred-for-believing-the-resurrection-a-blast-from-the-past](https://ehrmanblog.org/were-the-disciples-martyred-for-believing-the-resurrection-a-blast-from-the-past)

    [6]: Karen Stollznow, [https://www.psychologytoday.com/us/blog/speaking-in-tongues/202311/grief-hallucinations#:~:text=How%20common%20are%20grief%20hallucinations,with%20their%20lost%20loved%20one.](https://www.psychologytoday.com/us/blog/speaking-in-tongues/202311/grief-hallucinations#:~:text=How%20common%20are%20grief%20hallucinations,with%20their%20lost%20loved%20one.)

    [7]: Bart Ehrman, How Jesus Became God: The Exaltation of a Jewish Preacher from Galilee

    [8]: Aziz Al-Azmeh, The Emergence of Islam in Late Antiquity: Allah and His People, [https://en.wikipedia.org/wiki/Splitting_of_the_Moon#cite_note-FOOTNOTEAl-Azmeh2017309-2](https://en.wikipedia.org/wiki/Splitting_of_the_Moon#cite_note-FOOTNOTEAl-Azmeh2017309-2)