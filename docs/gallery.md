...
<div class="terminal-window">
  <div class="terminal-titlebar">
    <div class="terminal-title-left">
      <span class="terminal-title">📷 acts8-36.png</span>
    </div>
  ...
  <div class="terminal-content">
    <img src="/assets/acts8-36.png" alt="acts8-36" />
    <div class="terminal-caption" data-kind="info">
      First baptism on Titan in liquid methane.
    </div>
  </div>
</div>
...
<div class="terminal-window">
  <div class="terminal-titlebar">
    <div class="terminal-title-left">
      <span class="terminal-title">📷 m19-26-full.png</span>
    </div>
    <div class="terminal-buttons">
        <span class="min">—</span>
        <span class="max">□</span>
  ...
  <div class="terminal-content">
    <img src="/assets/m19-26.png" alt="m19-26" />
    <div class="terminal-caption" data-kind="info">
